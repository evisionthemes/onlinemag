...
if ( ! function_exists( 'onlinemag_featured_home_slider' ) ) :
    ...
    <section class="wrapper below-header">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 pad0r left-content">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5 pad0l mainslider-right-content right-content">
                    <div class="row">
                        <?php
                 ...
                 <div class="col-xs-12 col-sm-12 col-md-5 second-section pad0l mainslider-right-content right-content">
                    <div class="row">
                        <?php
                        $onlinemag_slider_posts_args =    array(
                            'post_type' => 'post',
